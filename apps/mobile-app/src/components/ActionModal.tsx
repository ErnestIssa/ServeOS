    ...
    () =>
      StyleSheet.create({
        backdrop: {
          ...
          backgroundColor: isDark ? "rgba(0,0,0,0.78)" : "rgba(2,6,23,0.62)"
        },
        ...
        card: {
          ...
          borderWidth: 1,
          borderColor: isDark ? t.border : "rgba(254,202,202,0.95)",
          padding: 16,
          ...Platform.select({
        ...
        redDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: t.danger },
        title: { flex: 1, fontSize: 16, fontWeight: "900", color: t.text, letterSpacing: -0.2 },
        message: { marginTop: 10, fontSize: 14, lineHeight: 20, color: t.textSecondary, fontWeight: "600" },
